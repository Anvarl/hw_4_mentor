...
public class Main {
    ...
    public static String[] heroesAttackType = {"Physical", "Magical", "Kinetic", "Medic",  "Lucky", "Berserk", "Thor"};
    public static int[] heroesHealth = {270, 260, 250, 240,  250, 260, 240};
    public static int[] heroesDamage = {10, 15, 20, 0,  15, 20, 10};
